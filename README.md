...
| [KRT Validation Rules](./docs/krt-validation-rules.md) | What triggers an error / warning / silent pass on each KRT column; which identifier formats the app recognizes and which each resource type accepts (with a verified matrix); how errors gate "Continue" |
